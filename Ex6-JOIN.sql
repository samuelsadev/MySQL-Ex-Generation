...
SELECT tb_produtos.id, tb_produtos.nome, tb_produtos.descricao, tb_produtos.valor, tb_produtos.estoque, tb_categorias.nome AS categoria_nome, tb_categorias.descricao AS categoria_descricao
FROM tb_produtos
